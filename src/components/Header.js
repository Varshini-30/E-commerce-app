          ...
          <div className='row'>
            ...
            <div className='col-6'>
              <p className='text-end text-white'>
                Hotline:
                <a className='text-white' href='tel:+ 91 7689230172'>+ 91 7689230172</a></p>
            </div>
          </div>
        </div>
      </header>
              ...
              <div className='menu-bottom d-flex align-items-center gap-30'>
                <div>
                  <div className="dropdown">
                    <button className="btn btn-secondary dropdown-toggle bg-transparent border-0 gap-15 md-5 d-flex align-items-center"

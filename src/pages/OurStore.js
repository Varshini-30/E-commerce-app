                    ...
                    <div className='row'>
                        <div className='col-3'>
                            ...
                            <div className='filter-card mb-3'>
                                ...
                                <div>
                                    <h5 className='sub-title'>Avalibality</h5>
                                    <div>
                            ...
                            <div className='filter-card mb-3'>
                                ...
                                <div>
                                    <div className='priduct-tags d-flex flex-wrap align-items-center gap-10'>
                            ...
                            <div className='filter-card mb-3'>
                                ...
                                <div>
                                    ...
                                    <div className='random-products mb-3 d-flex'>
                                        <div className='w-50'>
                                            <img src='images/watch-3.jpg' className='img-fluid' alt='watch' />
                                        </div>
                                        <div className='w-50'>
                                ...
                                <div className='d-flex justify-content-between align-items-center'>
                                    <div className='d-flex align-items-center gap-10'>
                                        ...
                                        <select
                                            ...
                                            <option value='best-selling' selected='selected'>BestSelling</option>
                                            <option value='title-ascending'>Alphabetically, Z-A</option>
                                            <option value='Price-accend'>Price, low to high</option>
